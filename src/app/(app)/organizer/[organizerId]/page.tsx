      ...
      <Motion as="div" variants={shrinkIn} delay={0.2}>
        <div className="relative -mt-5 rounded-t-3xl bg-n-50 container mx-auto px-4 pb-6 text-n-900 flex flex-col gap-6">
          ...
          <div className="size-24 absolute -top-12 overflow-hidden rounded-full border border-n-50">
            <Image
              src="/images/defaults/organizer-profile.jpg"
          ...
          <div className="flex flex-col gap-4 pt-14">
            <div className="flex flex-col">
              ...
              <p className="text-sm font-normal text-n-700">Andheri, Mumbai</p>
            </div>
          ...
          <div className="flex flex-col gap-3">
            ...
            <TestimonialCard
              ...
              avatarUrl="/images/defaults/organizer-profile.jpg"
            />
          </div>
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex gap-2.5 overflow-x-auto scrollbar-hide ">
              {[
                "/images/defaults/organizer-cover.jpg",
                "/images/defaults/organizer-cover.jpg",
              ].map((src, index) => (
                <Image
                  key={index}
