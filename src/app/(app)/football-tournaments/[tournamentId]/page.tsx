...
// SERVICES //
import { getTournamentDetails } from "@/services/queries/tournaments.query";
...
export default function TournamentDetails() {
  ...
  const getTournamentDetailsRequest = async () => {
    try {
      // Set Loading State
      setIsLoading(true);

      // Get Tournament Details
      const { data, error } = await getTournamentDetails(tournamentId);
