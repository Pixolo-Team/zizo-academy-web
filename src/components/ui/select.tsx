...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        " rounded-[20px] leading-tight data-[placeholder]:text-n-950 [&_svg:not([class*='text-'])]:text-n-950  dark:bg-n-50 dark:hover:bg-n-50 flex w-fit items-center justify-between gap-2.5  px-4 py-2.5 text-base whitespace-nowrap -xs transition-[color] outline-none focus-visible:ring-[3px] disabled:cursor-not-allowed disabled:opacity-50 data-[size=default]:h-10 data-[size=sm]:h-8 *:data-[slot=select-value]:line-clamp-1 *:data-[slot=select-value]:flex *:data-[slot=select-value]:items-center *:data-[slot=select-value]:gap-2 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 bg-n-50 text-n-950 ",
        className
      )}
      {...props}
    >
